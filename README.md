...
# 7. Дополнительный residual/shrinkage эксперимент
python run_segment_residual_calibration.py

# 8. AdVance-inspired neural multi-task baseline
python run_advance_like_baseline.py

# 9. Probabilistic user-level exposure simulator
python run_probabilistic_exposure_simulator.py

# 10. Residual Ridge с simulator diagnostics
python run_hazard_feature_residual.py

# 11. Selection-only target blend
python run_selection_model_blend.py

# 12. Temporal-local residual Ridge
python run_temporal_weighted_residual.py

# 13. Temporal-source selection blend
